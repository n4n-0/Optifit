...
var __PRIVATE_FirestoreIndexValueWriter = class {
  ...
  Et(e, t) {
    if ("nullValue" in e)
      ...
      isNaN(n) ? this.At(t, 13) : (this.At(t, 15), __PRIVATE_isNegativeZero(n) ? t.Rt(0) : t.Rt(n));
...
var __PRIVATE_IndexedDbIndexManager = class {
  constructor(e, t) {
    this.user = e, this.databaseId = t, this.an = new __PRIVATE_MemoryCollectionParentIndex(), this.un = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), (e2, t2) => __PRIVATE_targetEquals(e2, t2)), this.uid = e.uid || "";
  }
  addToCollectionParentIndex(e, t) {
    if (!this.an.has(t)) {
  ...
  Tn(e) {
    ...
    return __PRIVATE_FirestoreIndexValueWriter.vt.Tt(e, t.Yt(0)), t.zt();
  }
  Rn(e, t) {
    const n = new __PRIVATE_IndexByteEncoder();
...
var __PRIVATE_IndexedDbMutationQueue = class {
  constructor(e, t, n, r2) {
    this.userId = e, this.serializer = t, this.indexManager = n, this.referenceDelegate = r2, this.vn = {};
  }
  static Pt(e, t, n, r2) {
...
var __PRIVATE_QueryEngine = class {
  ...
  Wi(e, t) {
    ...
    return this.indexManager.getIndexType(e, n).next((r2) => 0 === r2 ? null : (null !== t.limit && 1 === r2 && (t = __PRIVATE_queryWithLimit(t, null, "F"), n = __PRIVATE_queryToTarget(t)), this.indexManager.getDocumentsMatchingTarget(e, n).next((r3) => {
      ...
      return this.Ui.getDocuments(e, i).next((r4) => this.indexManager.getMinOffset(e, n).next((n2) => {
        ...
        return this.Hi(t, s, i, n2.readTime) ? this.Wi(e, __PRIVATE_queryWithLimit(t, null, "F")) : this.Ji(e, s, t, n2);
      }));
    })));
  }
  Gi(e, t, n, r2) {
  ...
  Ji(e, t, n, r2) {
    return this.Ui.getDocumentsMatchingQuery(e, n, r2).next((e2) => (t.forEach((t2) => {
...
var __PRIVATE_LocalStoreImpl = class {
  constructor(e, t, n, r2) {
    this.persistence = e, this.Yi = t, this.serializer = r2, this.Zi = new SortedMap(__PRIVATE_primitiveComparator), this.Xi = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), __PRIVATE_targetEquals), this.es = /* @__PURE__ */ new Map(), this.ts = e.getRemoteDocumentCache(), this.Qr = e.getTargetCache(), this.$r = e.getBundleCache(), this.ns(n);
  }
  ns(e) {
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r2, i) {
    this.window = e, this.oi = t, this.persistenceKey = n, this.Es = r2, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.ds = this.As.bind(this), this.Rs = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, this.Vs = [];
    const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.fs = createWebStorageClientStateKey(this.persistenceKey, this.Es), this.gs = function createWebStorageSequenceNumberKey(e2) {
      return `firestore_sequence_number_${e2}`;
    }(this.persistenceKey), this.Rs = this.Rs.insert(this.Es, new __PRIVATE_LocalClientState()), this.ps = new RegExp(`^firestore_clients_${s}_([^_]*)$`), this.ys = new RegExp(`^firestore_mutations_${s}_(\\d+)(?:_(.*))?$`), this.ws = new RegExp(`^firestore_targets_${s}_(\\d+)$`), this.Ss = function createWebStorageOnlineStateKey(e2) {
    ...
    }(this.persistenceKey), this.window.addEventListener("storage", this.ds);
  }
  static v(e) {
  ...
  async start() {
    ...
    for (const e2 of this.Vs)
      this.As(e2);
    this.Vs = [], this.window.addEventListener("pagehide", () => this.shutdown()), this.started = true;
  }
...
var __PRIVATE_WebChannelConnection = class extends class __PRIVATE_RestConnection {
  ...
  bo(e, t, n) {
    ...
    void 0 !== a && (_.longPollingTimeout = Math.round(1e3 * a)), this.useFetchStreams && (_.useFetchStreams = true), this.yo(_.initMessageHeaders, t, n), _.encodeInitMessageHeaders = true;
    const u = i.join("");
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          void 0 === n3 && (n3 = D2.INTERNAL, i3 = "Unknown error status: " + t3 + " with message " + o2.message), h = true, P2.To(new FirestoreError(n3, i3)), c.close();
        } else
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(e, t, n = 1e3, r2 = 1.5, i = 6e4) {
    this.oi = e, this.timerId = t, this.Do = n, this.vo = r2, this.Co = i, this.Fo = 0, this.Mo = null, this.xo = Date.now(), this.reset();
  }
  reset() {
    this.Fo = 0;
  }
  ...
  No(e) {
    ...
    r2 > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${r2} ms (base delay: ${this.Fo} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`), this.Mo = this.oi.enqueueAfterDelay(this.timerId, r2, () => (this.xo = Date.now(), e())), this.Fo *= this.vo, this.Fo < this.Do && (this.Fo = this.Do), this.Fo > this.Co && (this.Fo = this.Co);
  }
  Lo() {
...
var __PRIVATE_PersistentStream = class {
  constructor(e, t, n, r2, i, s, o, _) {
    this.oi = e, this.ko = n, this.qo = r2, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, this.Qo = 0, this.Ko = null, this.$o = null, this.stream = null, this.Uo = new __PRIVATE_ExponentialBackoff(e, t);
  }
  Wo() {
  ...
  async close(e, t) {
    this.Zo(), this.Xo(), this.Uo.cancel(), this.Qo++, 4 !== e ? this.Uo.reset() : t && t.code === D2.RESOURCE_EXHAUSTED ? (__PRIVATE_logError(t.toString()), __PRIVATE_logError("Using maximum backoff delay to prevent overloading the backend."), this.Uo.Oo()) : t && t.code === D2.UNAUTHENTICATED && 3 !== this.state && (this.authCredentialsProvider.invalidateToken(), this.appCheckCredentialsProvider.invalidateToken()), null !== this.stream && (this.e_(), this.stream.close(), this.stream = null), this.state = e, await this.listener.lo(t);
  }
  e_() {
  }
  auth() {
...
var __PRIVATE_PersistentWriteStream = class extends __PRIVATE_PersistentStream {
  ...
  onMessage(e) {
    if (__PRIVATE_hardAssert(!!e.streamToken), this.lastStreamToken = e.streamToken, this.a_) {
      this.Uo.reset();
...
async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
  ...
  const a = (await i.So("RunAggregationQuery", _, s, 1)).filter((e2) => !!e2.result);
...
var __PRIVATE_OnlineStateTracker = class {
  constructor(e, t) {
    this.asyncQueue = e, this.onlineStateHandler = t, this.state = "Unknown", this.d_ = 0, this.A_ = null, this.R_ = true;
  }
  V_() {
    0 === this.d_ && (this.m_("Unknown"), this.A_ = this.asyncQueue.enqueueAfterDelay("online_state_timeout", 1e4, () => (this.A_ = null, this.f_("Backend didn't respond within 10 seconds."), this.m_("Offline"), Promise.resolve())));
  }
  g_(e) {
    "Online" === this.state ? this.m_("Unknown") : (this.d_++, this.d_ >= 1 && (this.p_(), this.f_(`Connection failed 1 times. Most recent error: ${e.toString()}`), this.m_("Offline")));
  }
  set(e) {
    this.p_(), this.d_ = 0, "Online" === e && (this.R_ = false), this.m_(e);
  }
  m_(e) {
...
var __PRIVATE_RemoteStoreImpl = class {
  constructor(e, t, n, r2, i) {
    this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.y_ = [], this.w_ = /* @__PURE__ */ new Map(), this.S_ = /* @__PURE__ */ new Set(), this.b_ = [], this.D_ = i, this.D_.Xs((e2) => {
      n.enqueueAndForget(async () => {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug("RemoteStore", "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e3) {
          ...
          t2.S_.add(4), await __PRIVATE_disableNetworkInternal(t2), t2.v_.set("Unknown"), t2.S_.delete(4), await __PRIVATE_enableNetworkInternal(t2);
        }(this));
      });
...
function __PRIVATE_remoteStoreListen(e, t) {
  const n = __PRIVATE_debugCast(e);
  n.w_.has(t.targetId) || (n.w_.set(t.targetId, t), __PRIVATE_shouldStartWatchStream(n) ? __PRIVATE_startWatchStream(n) : __PRIVATE_ensureWatchStream(n).Go() && __PRIVATE_sendWatchRequest(n, t));
}
function __PRIVATE_remoteStoreUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = __PRIVATE_ensureWatchStream(n);
  n.w_.delete(t), r2.Go() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.w_.size && (r2.Go() ? r2.Ho() : __PRIVATE_canUseNetwork(n) && n.v_.set("Unknown"));
}
...
async function __PRIVATE_onWatchStreamClose(e, t) {
  __PRIVATE_cleanUpWatchStreamState(e), __PRIVATE_shouldStartWatchStream(e) ? (e.v_.g_(t), __PRIVATE_startWatchStream(e)) : e.v_.set("Unknown");
}
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  if (e.v_.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause)
    try {
    ...
    try {
      ...
      n.compareTo(t2) >= 0 && await function __PRIVATE_raiseWatchSnapshot(e2, t3) {
        ...
        return n2.targetChanges.forEach((n3, r2) => {
          ...
          if (!r2)
            return;
          e2.w_.set(t4, r2.withResumeToken(ByteString.EMPTY_BYTE_STRING, r2.snapshotVersion)), __PRIVATE_sendUnwatchRequest(e2, t4);
...
async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  if (!__PRIVATE_isIndexedDbTransactionError(t))
    throw t;
  e.S_.add(1), await __PRIVATE_disableNetworkInternal(e), e.v_.set("Offline"), n || (n = () => __PRIVATE_localStoreGetLastRemoteSnapshotVersion(e.localStore)), e.asyncQueue.enqueueRetryable(async () => {
    __PRIVATE_logDebug("RemoteStore", "Retrying IndexedDB access"), await n(), e.S_.delete(1), await __PRIVATE_enableNetworkInternal(e);
  });
}
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  t && __PRIVATE_ensureWriteStream(e).u_ && await async function __PRIVATE_handleWriteError(e2, t2) {
    if (function __PRIVATE_isPermanentWriteError(e3) {
      return __PRIVATE_isPermanentError(e3) && e3 !== D2.ABORTED;
    }(t2.code)) {
      const n = e2.y_.shift();
      __PRIVATE_ensureWriteStream(e2).jo(), await __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), await __PRIVATE_fillWritePipeline(e2);
    }
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  ...
  n.S_.add(3), await __PRIVATE_disableNetworkInternal(n), r2 && n.v_.set("Unknown"), await n.remoteSyncer.handleCredentialChange(t), n.S_.delete(3), await __PRIVATE_enableNetworkInternal(n);
}
async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  t ? (n.S_.delete(2), await __PRIVATE_enableNetworkInternal(n)) : t || (n.S_.add(2), await __PRIVATE_disableNetworkInternal(n), n.v_.set("Unknown"));
}
function __PRIVATE_ensureWatchStream(e) {
  return e.F_ || (e.F_ = function __PRIVATE_newPersistentWatchStream(e2, t, n) {
    ...
    t ? (e.F_.jo(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.v_.set("Unknown")) : (await e.F_.stop(), __PRIVATE_cleanUpWatchStreamState(e));
  })), e.F_;
}
function __PRIVATE_ensureWriteStream(e) {
  return e.M_ || (e.M_ = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    const r2 = __PRIVATE_debugCast(e2);
    ...
    t ? (e.M_.jo(), await __PRIVATE_fillWritePipeline(e)) : (await e.M_.stop(), e.y_.length > 0 && (__PRIVATE_logDebug("RemoteStore", `Stopping write stream with ${e.y_.length} pending writes`), e.y_ = []));
  })), e.M_;
}
...
var __PRIVATE_DocumentChangeSet = class {
  ...
  track(e) {
    ...
    n ? 0 !== e.type && 3 === n.type ? this.x_ = this.x_.insert(t, e) : 3 === e.type && 1 !== n.type ? this.x_ = this.x_.insert(t, {
      type: n.type,
      doc: e.doc
...
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  if (n.queries.set(r2, s), s.listeners.push(t), t.L_(n.onlineState), s.N_) {
...
var __PRIVATE_QueryListener = class {
  constructor(e, t, n) {
    this.query = e, this.q_ = t, this.Q_ = false, this.K_ = null, this.onlineState = "Unknown", this.options = n || {};
  }
  k_(e) {
...
var __PRIVATE_View = class {
  constructor(e, t) {
    this.query = e, this.ta = t, this.na = null, this.hasCachedResults = false, this.current = false, this.ra = __PRIVATE_documentKeySet(), this.mutatedKeys = __PRIVATE_documentKeySet(), this.ia = __PRIVATE_newQueryComparator(e), this.sa = new DocumentSet(this.ia);
  }
  get oa() {
    return this.ta;
  }
  ...
  Pa(e) {
    return !this.ta.has(e) && (!!this.sa.has(e) && !this.sa.get(e).hasLocalMutations);
  }
  ca(e) {
...
var LimboResolution = class {
  constructor(e) {
    this.key = e, this.Ea = false;
  }
};
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r2, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r2, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.da = {}, this.Aa = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.Ra = /* @__PURE__ */ new Map(), this.Va = /* @__PURE__ */ new Set(), this.ma = new SortedMap(DocumentKey.comparator), this.fa = /* @__PURE__ */ new Map(), this.ga = new __PRIVATE_ReferenceSet(), this.pa = {}, this.ya = /* @__PURE__ */ new Map(), this.wa = __PRIVATE_TargetIdGenerator.Bn(), this.onlineState = "Unknown", this.Sa = void 0;
  }
  get isPrimaryClient() {
    return true === this.Sa;
  }
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r2, i) {
  e.ba = (t2, n2, r3) => async function __PRIVATE_applyDocChanges(e2, t3, n3, r4) {
    ...
    i2.Hi && (i2 = await __PRIVATE_localStoreExecuteQuery(
      e2.localStore,
      t3.query,
      false
...
async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
  ...
  try {
    ...
    t.targetChanges.forEach((e3, t2) => {
      ...
      r2 && (__PRIVATE_hardAssert(e3.addedDocuments.size + e3.modifiedDocuments.size + e3.removedDocuments.size <= 1), e3.addedDocuments.size > 0 ? r2.Ea = true : e3.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r2.Ea) : e3.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r2.Ea), r2.Ea = false));
...
async function __PRIVATE_syncEngineRejectListen(e, t, n) {
  ...
  if (s) {
    ...
    await __PRIVATE_syncEngineApplyRemoteEvent(r2, i2), r2.ma = r2.ma.remove(s), r2.fa.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r2);
  } else
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  if (e.Ra.delete(t), e.isPrimaryClient) {
    e.ga.Vr(t).forEach((t2) => {
      e.ga.containsKey(t2) || __PRIVATE_removeLimboTarget(e, t2);
    });
  }
}
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r2 of n)
    if (r2 instanceof __PRIVATE_AddedLimboDocument)
      ...
      e.ga.containsKey(r2.key) || __PRIVATE_removeLimboTarget(e, r2.key);
    } else
      fail();
}
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r2.Sa) {
    ...
    for (const e2 of n)
      r2.Ra.has(e2) && await __PRIVATE_localStoreReleaseTarget(
        r2.localStore,
        e2,
        false
      ).then(() => {
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends MemoryOfflineComponentProvider {
  ...
  async initialize(e) {
    await super.initialize(e), await this.Ca.initialize(this, e), await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Ca.syncEngine), await __PRIVATE_fillWritePipeline(this.Ca.remoteStore), await this.persistence.fi(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
  }
  createLocalStore(e) {
    return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
  }
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(e, t, false), this.Ca = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
...
var OnlineComponentProvider = class {
  ...
  terminate() {
    return async function __PRIVATE_remoteStoreShutdown(e) {
      const t = __PRIVATE_debugCast(e);
      __PRIVATE_logDebug("RemoteStore", "RemoteStore shutting down."), t.S_.add(5), await __PRIVATE_disableNetworkInternal(t), t.D_.shutdown(), t.v_.set("Unknown");
    }(this.remoteStore);
  }
};
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    this.xa = e, this.serializer = t, this.metadata = new __PRIVATE_Deferred(), this.buffer = new Uint8Array(), this.Oa = function __PRIVATE_newTextDecoder() {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r2, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r2, this.deferred = i, this.Ka = n.maxAttempts, this.Uo = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry");
  }
  run() {
    this.Ka -= 1, this.$a();
  }
...
function __PRIVATE_canFallbackFromIndexedDbError(e) {
  return "FirebaseError" === e.name ? e.code === D2.FAILED_PRECONDITION || e.code === D2.UNIMPLEMENTED : !("undefined" != typeof DOMException && e instanceof DOMException) || (22 === e.code || 20 === e.code || 11 === e.code);
}
...
function __PRIVATE_firestoreClientEnableNetwork(e) {
  return e.asyncQueue.enqueue(async () => {
    ...
    return t.setNetworkEnabled(true), function __PRIVATE_remoteStoreEnableNetwork(e2) {
      const t2 = __PRIVATE_debugCast(e2);
      return t2.S_.delete(0), __PRIVATE_enableNetworkInternal(t2);
    }(n);
  });
}
function __PRIVATE_firestoreClientDisableNetwork(e) {
  return e.asyncQueue.enqueue(async () => {
    ...
    return t.setNetworkEnabled(false), async function __PRIVATE_remoteStoreDisableNetwork(e2) {
      const t2 = __PRIVATE_debugCast(e2);
      t2.S_.add(0), await __PRIVATE_disableNetworkInternal(t2), t2.v_.set("Offline");
    }(n);
  });
}
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    __PRIVATE_debugCast(e2).B_.add(t2), t2.next();
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor() {
    this.za = Promise.resolve(), this.ja = [], this.Ha = false, this.Ja = [], this.Ya = null, this.Za = false, this.Xa = false, this.eu = [], this.Uo = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry"), this.tu = () => {
  ...
  async iu() {
    if (0 !== this.ja.length) {
      ...
      this.ja.length > 0 && this.Uo.No(() => this.iu());
    }
  }
  ru(e) {
  ...
  enqueueAfterDelay(e, t, n) {
    this.nu(), this.eu.indexOf(e) > -1 && (t = 0);
...
var __PRIVATE_ParseContextImpl = class {
  constructor(e, t, n, r2, i, s) {
    this.settings = e, this.databaseId = t, this.serializer = n, this.ignoreUndefinedProperties = r2, void 0 === i && this.cu(), this.fieldTransforms = i || [], this.fieldMask = s || [];
  }
  get path() {
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(w2, "4.1.2", e), registerVersion(w2, "4.1.2", "esm2017");
}();
export {
